...
namespace Persistance.Migrations
{
    ...
    [Migration("20250522103738_model4")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Models.ChangeTemplate", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");

                    b.Property<Guid?>("AdmissionChangeId")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("AdmissionChangeId");

                    b.ToTable("ChangeTemplate");
                });
            ...
            modelBuilder.Entity("Domain.Models.ChangeTemplate", b =>
                {
                    b.HasOne("Domain.Models.Entities.AdmissionChange", null)
                        .WithMany("Data")
                        .HasForeignKey("AdmissionChangeId");
                });
            ...
            modelBuilder.Entity("Domain.Models.Entities.AdmissionChange", b =>
                {
                    b.HasOne("Domain.Models.Entities.Admission", null)
                        .WithMany("Changes")
